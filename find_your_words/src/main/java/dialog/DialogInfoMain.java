 ...
 */
public class DialogInfoMain extends DialogFragment 
{
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) 
	{
		...
		//get view
		view=inflater.inflate(R.layout.dialog_info_main, null);
		
		type =Typeface.createFromAsset(getActivity().getAssets(),"jennifer.ttf");
		setText(R.id.infoReload);
		setText(R.id.info_led);
		...
		.setPositiveButton("Done", new DialogInterface.OnClickListener()
		{
			...
			{
				DialogInfoMain.this.getDialog().cancel();
			}
		});
